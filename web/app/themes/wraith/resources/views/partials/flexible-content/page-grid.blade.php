            ...
            <div class="flex-wrap flex lg:justify-center snap-x overflow-x-scroll lg:overflow-hidden px-2">
                @while (have_rows('page_grid'))
                    ...
                    @endphp
                        ...
                        <{!! $custom_link ? 'a href="' . $custom_link['url'] . '"' : 'div' !!} class="w-full md:w-1/2 lg:w-1/3 px-2 mb-4 product-link" style="flex: 0 0 auto;">
                           <div class="embed-1by1 cursor-pointer w-full relative rounded-sm overflow-hidden mb-6 lg:mb-0">
                              <img data-src="{{ $custom_image['sizes']['4by3-sm'] }}" src="{{ $custom_image['sizes']['4by3-sm'] }}" alt="{!! $custom_image['alt'] !!}" class="lozad object-fit-cover" />
