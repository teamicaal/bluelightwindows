...
<section class="py-8 overflow-hidden{!! $custom_class ? ' ' . $custom_class : null; !!}">
  <div class="container mx-auto">
    {!! $title ? '<h3 class="text-[#39383A] capitalize font-bold text-center tracking-wide text-3xl lg:text-4xl mb-12 ">' . $title . '</h3>' : null; !!}
  </div>
