<section id="ppc_landing_banner" class="w-full relative overflow-hidden">
    ...
    <div class="relative container mx-auto flex flex-wrap lg:flex-row-reverse" style="margin:200px auto 2rem; padding:1rem 0;">
        ...
        <div class="w-full lg:w-1/2 p-1 flex flex-col items-center">
            ...
            <div class="content w-full text-center flex justify-center flex-col items-center lg:items-start lg:text-left text-white children:text-white">{!! get_sub_field('content') !!}</div>
        </div>
    </div>
</section>
                    ...
                    <div class="w-1/3">
                        <div class="w-full flex flex-col justify-center items-center p-8">
                            ...
                            @elseif( get_sub_field('svg'))
                                <div class="mx-auto m-2 ppc-svg-icon-holder" style="">{!! get_sub_field('svg') !!}</div>
                            @endif
